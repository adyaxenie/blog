...
import AsciiBlackhole2 from "@/app/components/AsciiBlackhole2";
...
type Scene = "earth" | "galaxy" | "blackhole" | "blackhole2";
...
export default function AsciiPage() {
  ...
  const Background = scene === "galaxy" ? AsciiGalaxy : scene === "blackhole" ? AsciiBlackhole : scene === "blackhole2" ? AsciiBlackhole2 : AsciiEarth;
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="fixed top-4 right-4 z-20 flex gap-2">
        {(["earth", "galaxy", "blackhole", "blackhole2"] as Scene[]).map((s) => (
          <button
            key={s}
            onClick={() => setScene(s)}
