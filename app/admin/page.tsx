...
function DashboardHeader({
  ...
  const { refresh, refreshing } = useMetricsRefresh();
    ...
    <header className="flex flex-wrap items-center justify-between gap-3">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          onClick={refresh}
          disabled={refreshing}
          title="Refresh RevenueCat, TikTok, and metrics"
          className="flex h-7 w-7 items-center justify-center rounded-lg border border-zinc-800 bg-zinc-900 text-zinc-500 transition-colors hover:text-zinc-300 disabled:opacity-50"
        >
